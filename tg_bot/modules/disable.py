...
if is_module_loaded(FILENAME):
    ...
    __help__ = """
	با قابلیت فیوز میتونی دستوراتی که برای کاربرات بازه ولی 
	خوشت نمیاد کاربرات از اون دستورا استفاده کنن خاموش کنی
	
 - /cmds: همه دستوراتی که غیر فعال هستند رو نشون میدم

*فقط ادمینها:*
 - /enable <نام دستور>: 
 اون دستورو فعال میکنم
 - /disable <نام دستور>: 
 اون دستور رو غیر فعال میکنم
 - /listcmds: لیست همه دستوراتی که میتونی فعال یا غیر فعال کنی رو نشون میدم
    """
