...
def no_longer_afk(bot: Bot, update: Update):
    ...
    if res:
        update.effective_message.reply_text("{} در دسترسه!".format(update.effective_user.first_name))
...
__help__ = """
 - /afk <دلیل>: 
 خودتون رو دور از دسترس علامت بزنید!.
 

وقتی حالت AFK برا شما فعال باشه . اگه کسی باهاتون کار داشته باشه داخل گپ من بهشون اطلاع میدم که فعلا نیستین!
"""

__mod_name__ = "دور از دسترس"
